...
7. Optionally enter a domain filter, such as `example.com`, to include only matching tabs and subdomains. `.onion` hostnames are accepted by the same exact-host/subdomain matching logic.
