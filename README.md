...
9. Enter JavaScript and click **Run in all tabs**, enter CSS and click **Inject CSS in all tabs**, click **Save open images/PDFs** (including open `data:image/...` tabs with autogenerated names), enter a CSS selector and click **Save selector matches**, or click **Preview selector images**.
