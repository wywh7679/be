...
- `POST /move-firefox-windows` with `{ "desktopId": "..." }` focuses each top-level Firefox window and sends the configured NVIDIA RTX Desktop Manager move-window hotkey for that desktop.
